#ifndef LONGARITHMETIC_POLYNOMIAL_H
#define LONGARITHMETIC_POLYNOMIAL_H
...
namespace LongArithmetic {
  ...
  public:
    typedef DataStructures::ArrayList<T> coefficient_list;
...
#endif // LONGARITHMETIC_POLYNOMIAL_H
