...
namespace Crypto {
  ...
  namespace DH {
    ...
    const number_t diffie_hellman_modulus_512 = number_t("0xFFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD129024E088A67CC74"
                                                         "020BBEA63B139B22514A08798E3404DDEF9519B3CD3A439DFFFFFFFFFFFFFFFF");
    ...
    const number_t diffie_hellman_modulus_2048_2 = number_t("0xfa6d3cb85ca608b967329e2b7514e976a9b5a707875f408e2b758bf6b20b57bd"
    ...
    const number_t diffie_hellman_modulus_2048_3 = number_t("0x942acc406c4f6c68f7d56f96b4efe8a314d624d11b0b7c9b5c0aca240406ba33"
    ...
    const number_t diffie_hellman_modulus_2560 = number_t("0xb8eb857df1eb89bc8c13ef777772d6f3d3716ecc671e5dfbb969c28ffc2c3383"
    ...
    const number_t diffie_hellman_modulus_3072 = number_t("0xc48f6e2843518c51000efb2aa67017951bca4b322b94c0ea1bb3f47444aa47a4"
    ...
    const number_t diffie_hellman_modulus_3584 = number_t("0xa01cadf74b4d06569caad9b77c3451e75d1f9e898833c7ad6fe533a1be8f77b3"
    ...
    const number_t diffie_hellman_modulus_4096 = number_t("0xaf0c858df6f08fdf9c65c46b862b8a49a89643bc8beb69d4fecad6dea6af8dc3"
    ...
    const number_t diffie_hellman_modulus_8192 = number_t("0x99134f625a7e28b61a2e610e1d55c5b1c01dc37f718c16116e482f500a046cca"
    ...
    const number_t diffie_hellman_generator_512 = 5;

    const number_t diffie_hellman_generator_1024 = 5;

    const number_t diffie_hellman_generator_2048_1 = 2;

    const number_t diffie_hellman_generator_2048_2 = 2;

    const number_t diffie_hellman_generator_2048_3 = 7;

    const number_t diffie_hellman_generator_2560 = 5;

    const number_t diffie_hellman_generator_3072 = 5;

    const number_t diffie_hellman_generator_3584 = 2;

    const number_t diffie_hellman_generator_4096 = 2;

    const number_t diffie_hellman_generator_8192;
